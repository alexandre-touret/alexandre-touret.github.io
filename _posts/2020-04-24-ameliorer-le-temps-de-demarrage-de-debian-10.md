...
<ul class="blocks-gallery-grid">
  <li class="blocks-gallery-item">
    <figure><a href="/assets/img/posts/2020/04/boot_avant.png"><img loading="lazy" width="6066" height="4013" src="/assets/img/posts/2020/04/boot_avant.png" alt="" data-id="350" class="wp-image-350" srcset="/assets/img/posts/2020/04/boot_avant.png 6066w, /assets/img/posts/2020/04/boot_avant-300x198.png 300w, /assets/img/posts/2020/04/boot_avant-1024x677.png 1024w, /assets/img/posts/2020/04/boot_avant-768x508.png 768w, /assets/img/posts/2020/04/boot_avant-1536x1016.png 1536w, /assets/img/posts/2020/04/boot_avant-2048x1355.png 2048w, /assets/img/posts/2020/04/boot_avant-1568x1037.png 1568w" sizes="(max-width: 6066px) 100vw, 6066px" /></a></figure>
  </li>
...
<img loading="lazy" width="783" height="55" src="/assets/img/posts/2020/04/boot_apres_header.png?w=783" alt="" class="wp-image-360" srcset="/assets/img/posts/2020/04/boot_apres_header.png 783w, /assets/img/posts/2020/04/boot_apres_header-300x21.png 300w, /assets/img/posts/2020/04/boot_apres_header-768x54.png 768w" sizes="(max-width: 783px) 100vw, 783px" /> </figure> 

Vous pourrez trouver le détail ci-dessous:<figure class="wp-block-gallery aligncenter columns-1 is-cropped">

<ul class="blocks-gallery-grid">
  <li class="blocks-gallery-item">
    <figure><a href="/assets/img/posts/2020/04/boot_apres-2.png?w=287"><img loading="lazy" width="1102" height="3930" src="/assets/img/posts/2020/04/boot_apres-2.png?w=287" alt="" data-id="362" data-link="https://blog.touret.info/boot_apres-2/" class="wp-image-362" srcset="/assets/img/posts/2020/04/boot_apres-2.png 1102w, /assets/img/posts/2020/04/boot_apres-2-84x300.png 84w, /assets/img/posts/2020/04/boot_apres-2-287x1024.png 287w, /assets/img/posts/2020/04/boot_apres-2-768x2739.png 768w, /assets/img/posts/2020/04/boot_apres-2-431x1536.png 431w, /assets/img/posts/2020/04/boot_apres-2-574x2048.png 574w" sizes="(max-width: 1102px) 100vw, 1102px" /></a></figure>
  </li>
